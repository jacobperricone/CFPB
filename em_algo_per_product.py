...
def main():
    ...
    for product in top_products:
        ...
        tmp = em(tfdf, date_vec, entities_vec, num_defects, tol, max_iter, min_iter)
        tmp['vocab'] = vocab
        results[product] = tmp

    pickle.dump(results, open("Product_EM_" + str(num_defects) + '.pickle', "wb"))
